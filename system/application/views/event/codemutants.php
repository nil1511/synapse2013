...
<div id="accordion">
	...
	<div class="pane" style="display:block">
        ...
        Make your way through huge chunks of code, wriggling through complex loops on your way. Hope your programming skills pass this test of logic and computing!!
        </p>
       
        <p>CodeMutants will be conducted on the <a href="http://www.codechef.com">CodeChef platform</a></p>
     <p>You will need a CodeChef ID to register for the event.</p>
...
<h3> Date: 16 Feb 2012 Time: 8:30PM - 11:00PM</h3>
	...
	<div class="pane">
		<ol>
		   <li>There will be a total of 5-6 problems of varying difficulty levels.</li>
		   <li>The duration of the contest will be 2.5 hours only.</li>
	...
	<div class="pane">
		<ul>
			<li>   Programming Languages supported by the CodeChef platform are allowd.</li>
			<li>	Multiple submissions are allowed. See contest page for details of scoring.</li>
			<li>	Team submissions should be done using the CodeChef username specified during registration.</li>
	...
	<div class="pane">
		<ul>
			<li>Aman Agarwal 9510337942</li>
			<li>Dipesh Shah 8866256954</li>
			<li>Amar Mehta 9510180030</li>
		</ul>
	</div>
</div>