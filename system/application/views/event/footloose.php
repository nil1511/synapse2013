...
<div id="accordion">
	...
	<div class="pane">
		<ol>
			<li>Prelims:  Perform a relevant sequence of the main performance</li>
			...
			<li>Solo: <br>Time limit: 3-6 minutes (including setup)</li>
			<li>Dance Duo: <br>Time limit: 4-6 minutes (including setup)</li>
			<li>Group: <br>Team size for group category : 5-12 <br> Time Limit : 6-8 minutes (including setup)</li>
		</ol>
	</div>
