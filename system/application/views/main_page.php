      ...
      <dt id="aboutus" class="poster">
        <div id="tag" class="at" style="top:30%;">
          <div id="asd" class="rsd">
            <p>Synapse is the annual cultural festival of DA-IICT. Started way back in the 2003, the festival is in its 9th edition now and has become the most awaited days of the year for a college community.</p>
            <br/>
      ...
      <dt id="sponsors" class="poster">
        <div id="tag" class="at" style="top:50%"><span id="ftag" class="crt" style="border-left:none;">Sponsors
          ...
          <div id="sd" class="data">
            ...
            <label id="viewsponsor" style="padding:0px 0 0px 20px;position:relative;top:10px;cursor:pointer;">View All</label>
          </div>
          </span></div>
      </dt>
  ...
  <div id="eventdata" class="indata">
    <div style="position:fixed;top:0px;left:0px;width:100%;height:100%;">
        ...
        <div id="cult">
          <div class="cont">
            <div><br>
              ...
              <span class="item cnam">Proscenium<label class="sub">Stage Play</label></span><span class="item cnam">Naivete<label class="sub">Street Play</label></span><span class="item cnam">Instinct<label class="sub">On The Spot</label></span><span class="item cnam">Felicity<label class="sub">Musical Play</label></span>
              ...
              <span class="item cnam">HeadRush<label class="sub">Quiz&amp;Debate</label></span><!--<span class="item cnam">JAM<label class="sub">Quiz&amp;Debate</label></span><span class="item cnam">Mizmaze<label class="sub">Quiz&amp;Debate</label></span>--><span class="item cnam">Parley<label class="sub">Quiz&amp;Debate</label></span>
          ...
          <div class="cont">
            <div style="overflow-x:auto;height:inherit;"><br>
             ...
             <!-- <div class="cat">Nexus</div>
              ...
              <span class="item tnam">Counterstrike</span><span class="item tnam">NFS</span><span class="item tnam">Quake 3</span><span class="item tnam">Age of Empires</span><span class="item tnam">FIFA</span><span class="item tnam">DOTA</span><br>
              <br>
              <br>
              <br>
            </div>
      ...
      <div class="list">
        <div id="online">
          <div class="cont">
            <div style="width:100%;font-size:2em;position:relative;top:25%;text-align:center;"> Coming Soon </div>
          </div>
          <div class="eventpop">
            <div class="en"></div>
...
<!--<div class="ribbon-wrapper-green">
  <div class="ribbon-green"><strong>Beta</strong></div>
</div>-->
</body>
</html>