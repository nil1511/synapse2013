...
<div id="page-wrap">
    ...
    <dl class="cl">
        ...
        <div id="tag" class="at"  style="top:30%;">
            ...
            <div id="yttrailer"><br>Trailer</div>
          </div>
    ...
    <dl class="cr">
        ...
        <div id="tag" class="at" style="top:15%"><span id="ftag"  class="crt" style="border-left:none;">Youth Run
          <div class="v">View</div>
          <div class="clo"></div>
			<div id="yd" class="data"><div style="padding:5px;"> <br><h2>VISION</h2><br>
...
ideas that one believes are right and hence realizing their true potential.</div> <br ><label id="viewyouth">Click to View Site</label></div>
          </span></div>
      </dt>
        </dl>
  </div>
...
<div id="presents">
      <div id="topLoader" class="loader"><ul class="bokeh">
					<li></li>
					<li></li>
					<li></li>
					<li></li>
      ...
      <div id="syn">Synapse '13</div>
      <div id="syn1"><!--Synapse '13--></div>
...
<div id="gallery" class="pop"><!--<div class="close"></div>-->
